...
let inventory = [
    ...
    { code: "105", name: 'Aderezo cesar (x 500gr)', category: 'refrigerado', quantity: 7 },
    { code: "106", name: 'Agua nacimiento postobon con gas', category: 'refrigerado', quantity: 6 },
    { code: "107", name: 'Agua nacimiento (500gr)', category: 'refrigerado', quantity: 4 },
    { code: "108", name: 'Aguacate papelillo (10 diarios)', category: 'seco', quantity: 150 },
